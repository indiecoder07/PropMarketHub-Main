...
const TOOLS = [
  ...
  { name: 'Mortgage Calculator',    href: '#',                 status: 'Coming Soon', icon: '🏦', description: 'Model your borrowing power, estimate weekly repayments, and stress-test interest rate scenarios before committing to an Australian property purchase.' },
  { name: 'Stamp Duty Calculator',  href: '#',                 status: 'Coming Soon', icon: '🧾', description: 'Estimate stamp duty costs by state and territory. Understand upfront purchase costs for NSW, VIC, QLD, and more before making an offer.' },
  { name: 'Rental Yield Calculator',href: '#',                 status: 'Coming Soon', icon: '💰', description: 'Calculate gross and net rental yield, account for property management fees, maintenance, and vacancy to benchmark real return on investment.' },
];
      ...
      <section className={styles.introSection}>
        <div className={`container ${styles.introInner}`}>
          <p className={styles.introText}>
            ...
            the upcoming mortgage, stamp duty, and rental yield calculators.
          </p>
        </div>
      </section>
