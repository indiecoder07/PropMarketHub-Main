...
export const metadata: Metadata = {
  title: 'Free Property Investment Tools for Australia',
  description:
...
const TOOLS = [
  ...
  { name: 'House & Land Package Calculator', href: '/house-land-package-calculator', status: 'Live', icon: '🏗️', description: 'Compare Interest-Only and P&I repayments month-by-month as each construction stage drawdown increases your funded loan balance.' },
...
export default function HomePage() {
  ...
  const schema = {
    ...
    '@graph': [
      ...
      { '@type': 'Organization', '@id': 'https://propmarkethub.com.au/#organization', name: 'PropMarketHub', url: 'https://propmarkethub.com.au/', logo: 'https://propmarkethub.com.au/propmarkethub-logo.png', sameAs: ['https://www.linkedin.com/company/propmarkethub', 'https://twitter.com/propmarkethub'], areaServed: { '@type': 'Country', name: 'Australia' }, knowsAbout: ['Property investment', 'Real estate analysis', 'Suburb research', 'Australian property market', 'Rental yield', 'Stamp duty', 'Mortgage calculation'] },
        ...
        <div className={`container ${styles.howInner}`}>
          ...
          <div className={styles.stepsGrid}>
            {[
              ...
              { step: '2', heading: 'Model your mortgage repayments',      body: 'Once you have shortlisted a location and price range, estimate your weekly or monthly repayments, test interest rate scenarios, and calculate your maximum borrowing capacity.',                                                                                                                                  link: { label: 'Open Mortgage Calculator', href: '/mortgage-calculator' } },
              { step: '3', heading: 'Calculate stamp duty and rental yield',body: 'Before finalising a purchase, estimate your upfront stamp duty costs (all Australian states and territories) and calculate gross and net rental yield to confirm the investment stacks up.',                                                                                                                     link: { label: 'Open Stamp Duty Calculator', href: '/stamp-duty-calculator' } },
            ].map((item) => (
